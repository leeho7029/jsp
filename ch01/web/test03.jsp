...
<table class="table" id="tb1">
    ...
    <tr>
        ...
        <td><input type="text" name="year" id="year" min="1970" max="2023" step="1" value=""></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="checkbox" name="pet"  value="horse" id="pet3"><label for="pet3">망아지</label><br>
            <input type="checkbox" name="pet"  value="cow" id="pet4"><label for="pet4">송아지</label><br>
        </td>
    </tr>
    <tr>
        <td colspan="2">
